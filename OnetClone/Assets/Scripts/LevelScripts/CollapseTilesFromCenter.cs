...
public class CollapseTilesFromCenter : ICollapseStrategy
{
    ...
    public CollapseTilesFromCenter(MonoBehaviour monoBehaviour, Tile[,] tiles, int gridWidth, int gridHeight)
    {
